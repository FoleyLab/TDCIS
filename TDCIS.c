/*
  TDCIS.c - A time-domain configuration-interaction singles code for many-electron systems confined by infinite potential wells 
            and subject to arbitrary optical fields within the dipole approximation.
            
    Copyright (C) 2016  Jonathan J. Foley IV, Jason Codrington, Noor Eldabagh, Kimberly Fernando
